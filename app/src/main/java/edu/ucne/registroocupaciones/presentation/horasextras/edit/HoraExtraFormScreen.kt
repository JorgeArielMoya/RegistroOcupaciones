...
fun HoraExtraFormContent(
    ...
    Column(
        ...
        Box {
            ...
            Box(modifier = Modifier.matchParentSize().clickable { empleadoDropdownExpanded = true })
            DropdownMenu(
                ...
                state.empleados.forEach { empleado ->
                    DropdownMenuItem(
                        ...
                        onClick = {
                            onEvent(HoraExtraFormUiEvent.EmpleadoIdChanged(empleado.empleadoId))
                ...
                confirmButton = {
                    TextButton(onClick = {
                        dateDesdePickerState.selectedDateMillis?.let { millis ->
                            ...
                            onEvent(HoraExtraFormUiEvent.FechaDesdeChanged(localDate))
                        }
                ...
                confirmButton = {
                    TextButton(onClick = {
                        dateHastaPickerState.selectedDateMillis?.let { millis ->
                            val localDate = Instant.ofEpochMilli(millis)
                                .atZone(ZoneOffset.UTC).toLocalDate()
                            onEvent(HoraExtraFormUiEvent.FechaHastaChanged(localDate))
                        }
        ...
        OutlinedTextField(
            ...
            onValueChange = { onEvent(HoraExtraFormUiEvent.HorasTotalesChanged(it)) },
        ...
        OutlinedTextField(
            ...
            onValueChange = { onEvent(HoraExtraFormUiEvent.HorasNocturnasChanged(it)) },
        ...
        Button(
            onClick = { onEvent(HoraExtraFormUiEvent.Save) },
            modifier = Modifier.fillMaxWidth(),
        ...
        if (!state.isNew) {
            OutlinedButton(
                onClick = { onEvent(HoraExtraFormUiEvent.Delete) },
                modifier = Modifier.fillMaxWidth(),
